...
public class SoundFile {
    ...
    public static SoundFile create(Context context, Uri fileUri,
        ...
        soundFile.ReadFile(context, fileUri);
        return soundFile;
    }
    ...
    private void ReadFile(Context context, Uri inputFile)
            throws java.io.IOException, InvalidInputException {
        ...
        if (i == numTracks) {
            throw new InvalidInputException("No audio track found in " + mInputFile.toString());
        }
        mChannels = format.getInteger(MediaFormat.KEY_CHANNEL_COUNT);
        mSampleRate = format.getInteger(MediaFormat.KEY_SAMPLE_RATE);
        //long mDuration = format.getInteger(MediaFormat.KEY_DURATION);
        // Expected total number of samples per channel.
        //int expectedNumSamples =(int)((mDuration / 1000000.f) * mSampleRate + 0.5f);
            ...
            if (!done_reading && inputBufferIndex >= 0) {
                ...
                if (firstSampleData
                    ...
                    if (mProgressListener != null) {
                        if (!mProgressListener.reportProgress((float)(tot_size_read))) {
